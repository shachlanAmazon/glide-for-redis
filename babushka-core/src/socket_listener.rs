...
use redis::{Cmd, Value};
use redis::{KnownCommand, RedisError};
...
fn get_command(request: &Command) -> Option<Cmd> {
    ...
    match request_enum {
        ...
        RequestType::GetString => Some(Cmd::known_command(KnownCommand::Get)),
        RequestType::SetString => Some(Cmd::known_command(KnownCommand::Set)),
        RequestType::Ping => Some(Cmd::known_command(KnownCommand::Ping)),
        RequestType::Info => Some(Cmd::known_command(KnownCommand::Info)),
        RequestType::Del => Some(Cmd::known_command(KnownCommand::Del)),
        RequestType::Select => Some(Cmd::known_command(KnownCommand::Select)),
        RequestType::ConfigGet => Some(Cmd::known_command(KnownCommand::ConfigGet)),
        RequestType::ConfigSet => Some(Cmd::known_command(KnownCommand::ConfigSet)),
        RequestType::ConfigResetStat => Some(Cmd::known_command(KnownCommand::ConfigResetstat)),
        RequestType::ConfigRewrite => Some(Cmd::known_command(KnownCommand::ConfigRewrite)),
        RequestType::ClientGetName => Some(Cmd::known_command(KnownCommand::ClientGetname)),
        RequestType::ClientGetRedir => Some(Cmd::known_command(KnownCommand::ClientGetredir)),
        RequestType::ClientId => Some(Cmd::known_command(KnownCommand::ClientId)),
        RequestType::ClientInfo => Some(Cmd::known_command(KnownCommand::ClientInfo)),
        RequestType::ClientKill => Some(Cmd::known_command(KnownCommand::ClientKill)),
        RequestType::ClientList => Some(Cmd::known_command(KnownCommand::ClientList)),
        RequestType::ClientNoEvict => Some(Cmd::known_command(KnownCommand::ClientNoEvict)),
        RequestType::ClientNoTouch => Some(Cmd::known_command(KnownCommand::ClientNoTouch)),
        RequestType::ClientPause => Some(Cmd::known_command(KnownCommand::ClientPause)),
        RequestType::ClientReply => Some(Cmd::known_command(KnownCommand::ClientReply)),
        RequestType::ClientSetInfo => Some(Cmd::known_command(KnownCommand::ClientSetinfo)),
        RequestType::ClientSetName => Some(Cmd::known_command(KnownCommand::ClientSetname)),
        RequestType::ClientUnblock => Some(Cmd::known_command(KnownCommand::ClientUnblock)),
        RequestType::ClientUnpause => Some(Cmd::known_command(KnownCommand::ClientUnpause)),
        RequestType::Expire => Some(Cmd::known_command(KnownCommand::Expire)),
        RequestType::HashSet => Some(Cmd::known_command(KnownCommand::Hset)),
        RequestType::HashGet => Some(Cmd::known_command(KnownCommand::Hget)),
        RequestType::HashDel => Some(Cmd::known_command(KnownCommand::Hdel)),
        RequestType::HashExists => Some(Cmd::known_command(KnownCommand::Hexists)),
        RequestType::MSet => Some(Cmd::known_command(KnownCommand::Mset)),
        RequestType::MGet => Some(Cmd::known_command(KnownCommand::Mget)),
        RequestType::Incr => Some(Cmd::known_command(KnownCommand::Incr)),
        RequestType::IncrBy => Some(Cmd::known_command(KnownCommand::Incrby)),
        RequestType::IncrByFloat => Some(Cmd::known_command(KnownCommand::Incrbyfloat)),
        RequestType::Decr => Some(Cmd::known_command(KnownCommand::Decr)),
        RequestType::DecrBy => Some(Cmd::known_command(KnownCommand::Decrby)),
        RequestType::HashGetAll => Some(Cmd::known_command(KnownCommand::Hgetall)),
        RequestType::HashMSet => Some(Cmd::known_command(KnownCommand::Hmset)),
        RequestType::HashMGet => Some(Cmd::known_command(KnownCommand::Hmget)),
        RequestType::HashIncrBy => Some(Cmd::known_command(KnownCommand::Hincrby)),
        RequestType::HashIncrByFloat => Some(Cmd::known_command(KnownCommand::Hincrbyfloat)),
        RequestType::LPush => Some(Cmd::known_command(KnownCommand::Lpush)),
        RequestType::LPop => Some(Cmd::known_command(KnownCommand::Lpop)),
        RequestType::RPush => Some(Cmd::known_command(KnownCommand::Rpush)),
        RequestType::RPop => Some(Cmd::known_command(KnownCommand::Rpop)),
        RequestType::LLen => Some(Cmd::known_command(KnownCommand::Llen)),
        RequestType::LRem => Some(Cmd::known_command(KnownCommand::Lrem)),
        RequestType::LRange => Some(Cmd::known_command(KnownCommand::Lrange)),
        RequestType::LTrim => Some(Cmd::known_command(KnownCommand::Ltrim)),
        RequestType::SAdd => Some(Cmd::known_command(KnownCommand::Sadd)),
        RequestType::SRem => Some(Cmd::known_command(KnownCommand::Srem)),
        RequestType::SMembers => Some(Cmd::known_command(KnownCommand::Smembers)),
        RequestType::SCard => Some(Cmd::known_command(KnownCommand::Scard)),
        RequestType::PExpireAt => Some(Cmd::known_command(KnownCommand::Pexpireat)),
        RequestType::PExpire => Some(Cmd::known_command(KnownCommand::Pexpire)),
        RequestType::ExpireAt => Some(Cmd::known_command(KnownCommand::Expireat)),
        RequestType::Exists => Some(Cmd::known_command(KnownCommand::Exists)),
        RequestType::Unlink => Some(Cmd::known_command(KnownCommand::Unlink)),
        RequestType::TTL => Some(Cmd::known_command(KnownCommand::Ttl)),
    }
}
