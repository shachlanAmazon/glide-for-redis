...
export class SocketLikeClient {
  setReadBuffer(buffer: Uint8Array): void
  setWriteBuffer(buffer: Uint8Array): void
  write(length: number): Promise<number>
  read(offset: number, length: number): Promise<[number, number]>
  close(): void
}
